        ...
        <#if control.inputType(configInput)?is_boolean >
            ...
            <#if (configInput.counter)??>
                <div class="km-field__wrapper km-field__wrapper--counter <#if (configInput.formInline)?? && configInput.formInline> km-field__wrapper--inline</#if><#if (configInput.formInlineBreakpoint)??>@from-${configInput.formInlineBreakpoint} </#if>">
                    <button aria-label="moins" type="button" class="km-field__counter-button km-field__counter-button--left"
                    <#if (configInput.cerberusBtnMinus)??> <@macros.cerberus "${configInput.cerberusBtnMinus}" /> </#if>
                    >-</button>
            </#if>
                <input
                ...
                />
            <#if (configInput.counter)??>
                    <button aria-label="plus" type="button" class="km-field__counter-button km-field__counter-button--right"
                    <#if (configInput.cerberusBtnPlus)??> <@macros.cerberus "${configInput.cerberusBtnPlus}" /> </#if>
                    >+</button>
                </div>
            </#if>
