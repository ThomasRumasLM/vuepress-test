        ...
        <div class="km-selected-filters kl-hidden kl-visible@from-xl">
            ...
            <ul>
                ...
                <#assign buttonResetSelectedFilters = {
                    "displayStyle": "link",
                    "size": "s",
                    "cssClass": "js-reset-selected-filters",
                    "cerberus": "BTN_reinitialiser"
                }/>
                <li class="km-selected-filters__reset">
                    <@button.buttonMozaic configButton = buttonResetSelectedFilters >${lngList.translationList.filters.reset}</@button.buttonMozaic>
                </li>
            </ul>
        </div>
