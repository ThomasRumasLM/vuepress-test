    ...
    },
    {
      ...
      children: [
        ...
        '/pages/components/links/',
        {
          ...
          children: [
            '/pages/components/form/input/',
            '/pages/components/form/checkbox/',
            '/pages/components/form/radio/',
            '/pages/components/form/textarea/',
            '/pages/components/form/select/',
            '/pages/components/form/upload/',
            '/pages/components/form/counter/'
          ]
        },
      ]
    },
