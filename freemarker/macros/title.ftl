...
<#import "./tokens/title.ftl" as jsonTitle>
...
<#macro heading configHeading = {} dataSup...>
  ...
  <#assign mainClass = jsonTitle.json.class />
  <#assign strokeClass = jsonTitle.json.class + jsonTitle.json.stroke />
  <#assign underlineClass = jsonTitle.json.class + jsonTitle.json.underline />
  <#assign classes = mainClass />
  <#if configHeading.size?has_content>
    <#assign classes = classes + " ${mainClass}--${configHeading.size}"/>
  </#if>
  <#if configHeading.color?has_content>
    <#assign classes = classes + " ${mainClass}--${configHeading.color}"/>
  </#if>
  <#if configHeading.weight?has_content>
    <#assign classes = classes + " ${mainClass}--${configHeading.weight}"/>
  </#if>
  <#if configHeading.underline?has_content && configHeading.underline == true>
    <#assign classes = classes + " ${mainClass}--underline"/>
  </#if>
  <#if configHeading.underlineColor?has_content>
    <#assign classes = classes + " ${strokeClass}-${configHeading.underlineColor}"/>
  </#if>
  <#if configHeading.align?has_content>
    <#assign classes = classes + " ${mainClass}--${configHeading.align}"/>
  </#if>
  <#if dataSup.class?has_content>
    <#assign classes = classes + " ${dataSup.class}"/>
  </#if>

  <h${configHeading.heading} class="${classes}" ${dataAttributes}>
    <#nested>
  </h${configHeading.heading}>
</#macro>
