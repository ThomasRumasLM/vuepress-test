...
<#macro showPrice showPriceInformations isLight>
    ...
    <div class="km-price ${cssClass}">
       ...
       <#-- offerRefund tag -->
        <#if isLight == false>
            <#if (showPriceInformations.refundsOfferProductLabel)?? && (showPriceInformations.refundsOffermediaURL)??>
                <#assign tagLink = { "type" : "link" } />
                <@tags.tagMozaic configTag=tagLink href="${showPriceInformations.refundsOffermediaURL}" class="mc-tag-link--danger" target="_blank">
                    ${showPriceInformations.refundsOfferProductLabel}
                </@tags.tagMozaic>
            <#elseif (showPriceInformations.refundsOfferProductLabel)?has_content>
                <#assign tagText = { "type" : "text" } />
                <@tags.tagMozaic configTag=tagText class="mc-tag-text--danger">${showPriceInformations.refundsOfferProductLabel}</@tags.tagMozaic>
            </#if>
        </#if>
    </div>
</#macro>
